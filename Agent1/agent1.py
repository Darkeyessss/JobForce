...
def resume_agent1(order,JD,docu_RESUME):
    ...
    system_prompt2=(
                    "Please modify the resume based on the following instructions:"
...
"4. For entries that are not directly related to the JD, reframe them to highlight transferable skills such as leadership, communication, teamwork, or problem-solving."
"5. Maintain a concise, professional tone throughout."
    ...
    {
        'role': 'user',
        'content': "Just modify the resume according to the job description but keep every existing experience even if it is not relevant."
    }
    ]
